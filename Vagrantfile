...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "colincam-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/modcomp-wordpress-demo"
  #   chef.validation_client_name = "modcomp-wordpress-demo-validator"
  #   chef.validation_key_path = ".chef/modcomp-wordpress-demo-validator.pem"
  # end
end
